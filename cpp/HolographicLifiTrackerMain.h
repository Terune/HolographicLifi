...
namespace HolographicLifiTracker
{
    ...
    class HolographicLifiTrackerMain : public DX::IDeviceNotify
    {
    public:
        HolographicLifiTrackerMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~HolographicLifiTrackerMain();
    ...
    private:
        ...
        std::shared_ptr<LifiTrackerProcessor>                           m_LifiTrackerProcessor;
